# list of all available mentors for MDAnalysis

**Parent:** MDAnalysis — Project Ideas
**Source:** https://github.com/MDAnalysis/mdanalysis/wiki/Google-Summer-Of-Code
**Scraped:** 2026-03-10T16:58:40.304027

---

<img src="https://developers.google.com/open-source/gsoc/resources/downloads/GSoC-Vertical.svg" title="Google Summer of Code 2026" alt="Google Summer of Code 2024" align="right" width="33%"/>
...
If you just found out about the MDAnalysis Python package from the GSoC website, you can have a look at the [MDAnalysis 2021 Trailer](https://www.youtube.com/watch?v=uMAfvwFkD3o) [YouTube] to get an overview of the scope of the MDAnalysis package.

----

MDAnalysis is hosting  **[Google Summer of Code 2026](https://summerofcode.withgoogle.com/) Contributors**. In short (more details below — please read the whole page if you are interested!):

* The GSoC Contributor will be mentored by at least two experienced MDAnalysis developers and receive support from Google. 
* The GSoC Contributor will contribute code to the [MDAnalysis Project](https://www.mdanalysis.org) or to one of the collaborating projects.

Start by **reading the [MDAnalysis GSoC blog post](https://www.mdanalysis.org/2026/02/19/gsoc2026)** (if you haven't done so already) and then come back here and read the whole page. We also have a **[GSoC@MDAnalysis Frequently Asked Questions](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-FAQ)** page that we are updating as we get more questions.

The application window opens on  **March 16, 2026 - 18:00 UTC** and closes on **March 31, 2026 - 18:00 UTC** (see the [timeline](https://developers.google.com/open-source/gsoc/timeline)).

# Eligibility
[Eligibility requirements](https://developers.google.com/open-source/gsoc/faq#what_are_the_eligibility_requirements_for_participation) are described in the [GSoC FAQ](https://developers.google.com/open-source/gsoc/faq): 
...
# Project Ideas
Look at the [[Project Ideas 2026|GSoC 2026 Project Ideas]] page.

If you have your own idea, talk to us on [GitHub Discussions](https://github.com/MDAnalysis/mdanalysis/discussions) under the "Google Summer of Code" category.

**Previous Years**

- [Project Ideas 2025](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2025-Project-Ideas)
- [Project Ideas 2024](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2024-Project-Ideas)
- [Project Ideas 2023](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2023-Project-Ideas)
- [Project Ideas 2022](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2022-Project-Ideas)
- [Project Ideas 2021](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2021-Project-Ideas)
- [Project Ideas 2020](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2020-Project-Ideas)
- [Project Ideas 2019](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2019-Project-Ideas)
- [Project Ideas 2018](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2018-Project-Ideas)
- [Project Ideas 2017](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2017-Project-Ideas)
- [Project Ideas 2016](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2016-Project-Ideas)

# Who are we?

The MDAnalysis development team is friendly, cooperative and [informal](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-FAQ#how-do-we-interact-with-each-other). We consist of people from a wide range of backgrounds, including students, PhD-candidates, postdocs, professors and researchers actively using this software.
...
The MDAnalysis community values diversity and is committed to providing a productive, harassment-free environment to every member. Our [Code of Conduct](https://www.mdanalysis.org/conduct/) explains the values that we as a community uphold. *Every member (and every GSoC Contributor) agrees to follow the [Code of Conduct](https://www.mdanalysis.org/conduct/).*

## Available mentors

The following developers have expressed interest in mentoring for GSoC this year:

- Brady [@BradyAJohnston](https://github.com/BradyAJohnston)
- Oliver [@orbeckst](https://github.com/orbeckst)
- Valerij [@talagayev](https://github.com/talagayev)
- Yuxuan [@yuxuanzhuang](https://github.com/yuxuanzhuang)
- Matthias [@HeydenLabASU](https://github.com/HeydenLabASU)
- Amru [@amruthesht](https://github.com/amruthesht)
- Jeremy [@jeremyleung521](https://github.com/jeremyleung521)
- Lillian [@ltchong](https://github.com/ltchong)
- Nilay [@nilay-v3rma](https://github.com/nilay-v3rma)

The following developers will serve as organization administrators for GSoC this year:
- Jenna [@jennaswa](https://github.com/jennaswa)
- Irfan [@IAlibay](https://github.com/IAlibay)
- Oliver [@orbeckst](https://github.com/orbeckst)
...
We expect you to be an engaged member of the MDAnalysis community. In particular, by being a GSoC Contributor for MDAnalysis you agree to obey and uphold our [Code of Conduct](https://www.mdanalysis.org/conduct/).
...
5. Complete [preliminary requirements for your application](#application-requirements-and-timeline) early! The earlier you complete these requirements, the earlier you will be able to get feedback from us to improve your application.
...
1. Agree to be bound by our [Code of Conduct](https://www.mdanalysis.org/conduct/) (and [WESTPA's Code of Conduct](https://github.com/westpa/westpa/wiki/Code-of-Conduct) if you are applying for a WESTPA collaboration project [i.e., [Project 5](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2026-Project-Ideas#project-5-dashboard-for-tracking-westpa-simulation-progress), [Project 6](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2026-Project-Ideas#project-6-interface-for-post-analysis-analysis-crawling-of-westpa-simulations)]).
...
3. Watch the [MDAnalysis trailer](https://www.youtube.com/watch?v=uMAfvwFkD3o); [install](https://userguide.mdanalysis.org/stable/installation.html) the MDAnalysis package; and work through the [Quick Start Guide](https://userguide.mdanalysis.org/stable/examples/quickstart.html) to understand how MDAnalysis is being used.
...
5. Submit a **[pre-proposal](#submitting-a-pre-proposal)** as soon as possible, but no later than **March 9, 2026**.
6. Participate in a short **15-minute [video interview](#video-interview)** with one or more developers/mentors. **Selected applicants (based on your pre-proposal)** will be invited to schedule the interview. The interview may be recorded.
7. Submit a **[full application](#full-application)** for the final stage of the selection process. **Selected applicants from the interview stage** will be invited to submit a application. Full application applications from applicants who were not invited will not be reviewed.


#### Interactions and Engagement with MDAnalysis

GSoC contributors with MDAnalysis should demonstrate that they have been seriously engaged with the MDAnalysis project (and/or with a relevant [partner software project](https://github.com/MDAnalysis/mdanalysis/wiki/GSoC-2026-Project-Ideas#collaborations). Submitting a pull request is a great way to know you as a good candidate. As is relevant to the [[GSoC project idea|GSoC 2026 Project Ideas]] you are interested in, you should submit your PR in one of the following repositories:
...
We have a list of [easy bugs](https://github.com/MDAnalysis/mdanalysis/issues?q=is%3Aopen+is%3Aissue+label%3ADifficulty-easy) and
suggested [GSOC Starter issues](https://github.com/MDAnalysis/mdanalysis/issues?q=is%3Aopen+is%3Aissue+label%3A%22GSOC+Starter%22) to work on in our issue tracker
on GitHub. If you want to dive deeper, we
encourage you to tackle some of the other issues in our issue tracker or create a new one. We also appreciate contributions which add more tests or update/improve our documentation. Note that some of the [[GSoC 2026 Project Ideas]] include related issues that you might want to explore. Ultimately we want to know if you can work collaboratively (authentic communication, receptive to feedback, able to do distributed code development with `git` and GitHub), if you can write code *and understand your own and other's code*, if you are self-motivated, and if you can complete work.

To start developing for MDAnalysis have a look at our guide on
[contributing to MDAnalysis][dev-guide] and write to us on the [GSoC with MDAnalysis discussion forum](https://github.com/MDAnalysis/mdanalysis/discussions/categories/gsoc-discussions) if you have more questions
...
Submit your pre-proposal via the [MDAnalysis GSOC pre-proposal submission form](https://docs.google.com/forms/d/e/1FAIpQLSecYgZDLxSKHkHt0vSVwcfInDPG46xyHxb2XBIKl_KjZUHF4A/viewform?usp=publish-editor) **by March 9, 2026**. You should prepare the following information for your pre-proposal:
* Email address
* GitHub handle
* Real name (optional)
...
Within one week of your interview you will be informed if you are invited to submit the [Full Application](#full-application).
...
| :exclamation: Do not use generative AI to develop or write your proposal. We need to hear <em>your</em> ideas and voice.  |
|:-----------------------------------------|
| You are allowed to use AI tools for grammar and spell checking and for translation into English although we are more than happy to read your proposal in your own English words. |
...
[dev-guide]: https://www.mdanalysis.org/UserGuide/contributing_code.html
