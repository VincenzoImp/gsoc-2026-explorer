...
**Source:** https://wiki.videolan.org/SoC_2020/
**Scraped:** 2026-02-22T23:28:47.575458
...
This page gives the current list of ideas for VideoLAN project, for the [Google Summer Of Code 2020](https://summerofcode.withgoogle.com) program.
...
[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 How to Start](https://wiki.videolan.org#How_to_Start)[3 Ideas for VLC & libVLC](https://wiki.videolan.org#Ideas_for_VLC_.26_libVLC)[3.1 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[3.2 VLC Qt interface work](https://wiki.videolan.org#VLC_Qt_interface_work)[3.3 VLC.js](https://wiki.videolan.org#VLC.js)[3.4 VLC macOS interface redesign](https://wiki.videolan.org#VLC_macOS_interface_redesign)[3.5 Scripting VLC with wasm](https://wiki.videolan.org#Scripting_VLC_with_wasm)[3.6 GPU shader filters](https://wiki.videolan.org#GPU_shader_filters)[3.7 VLC iOS new UI](https://wiki.videolan.org#VLC_iOS_new_UI)[3.8 Interactive movie support](https://wiki.videolan.org#Interactive_movie_support)[3.9 Develop a MPD server inside VLC](https://wiki.videolan.org#Develop_a_MPD_server_inside_VLC)[3.10 Develop a UPnP server inside VLC](https://wiki.videolan.org#Develop_a_UPnP_server_inside_VLC)[3.11 Improve the web interface of VLC in Vue.js](https://wiki.videolan.org#Improve_the_web_interface_of_VLC_in_Vue.js)[3.12 Improve VLCKit Objective-C - Swift interoperability](https://wiki.videolan.org#Improve_VLCKit_Objective-C_-_Swift_interoperability)[3.13 Other ideas for VLC & libVLC](https://wiki.videolan.org#Other_ideas_for_VLC_.26_libVLC)

[4 Ideas for VideoLAN infrastructure](https://wiki.videolan.org#Ideas_for_VideoLAN_infrastructure)[5 Ideas for VLMC](https://wiki.videolan.org#Ideas_for_VLMC)[6 Ideas for dav1d](https://wiki.videolan.org#Ideas_for_dav1d)[7 Ideas for VLC dependencies](https://wiki.videolan.org#Ideas_for_VLC_dependencies)
...
- Code a UpNP server as a control module that will connect to the
[medialibrary](https://code.videolan.org/videolan/medialibrary)
