...
**Source:** https://wiki.videolan.org/SoC_2008/
**Scraped:** 2026-02-22T23:28:47.574518
...
*VideoLAN is an official mentoring organization* for [VLC media player](https://wiki.videolan.org/VLC_media_player/) and [x264](https://wiki.videolan.org/X264/) for Google Summer of Code 2008.

Look at the projects: [SoC_2008_projects](https://wiki.videolan.org/SoC_2008_projects/).
...
- There is also a separate page for project ideas for the
[x264](https://wiki.videolan.org/X264/):[SoC x264 2008](https://wiki.videolan.org/SoC_x264_2008/).

If you are a **student**, please read the [rules](https://wiki.videolan.org/SoC_2008_Rules/) and [advices](https://wiki.videolan.org/SoC_2008_Rules/#Advices).

### VLC media player

[VLC media player](https://wiki.videolan.org/VLC_media_player/) is a cross-platform Multimedia player, and encoding and streaming application.
It is one of the most successful open-source projects without any professional structure underneath.

[VLC media player](https://wiki.videolan.org/VLC_media_player/) is downloaded at an approximate monthly rate of 4 millions from the main website (not including third-party distributions (Linux)), which means about 30 million people have downloaded VLC 0.8.5 from the main website!
...
We (the VideoLAN team, and [jb](https://wiki.videolan.org/User:J-b/), the author of this page) have split this page in three lists of ideas:

- The
*main ideas*are the ones we would like to focus on, and seem to be key projects for VLC and a lot more*thrilling*than the other ones; we have assigned a potential mentor to each of these. - The other ideas are less detailed but could be good ideas too.
- Original good ideas will be valued. Last year, half of the ideas were given by students.
[Mini_Projects](https://wiki.videolan.org/Mini_Projects/)has some ideas too.
...
For x264 ideas, please see [SoC x264 2009](https://wiki.videolan.org/SoC_x264_2009/).
...
You should have a look at [libmtp library](http://libmtp.sf.net) and at [Songbird MTP implementation](http://blog.songbirdnest.com/2008/02/29/mtp-device-support-for-windows/).

*Proposed mentor: funman* (backup jb)

### QuickTimeVR Playback

This project deals with integration QuickTimeVR inside VLC using work from [FreePV](http://freepv.sf.net) (SoC 2007).
...
*Interested students:* [User:Plouj](https://wiki.videolan.org/User:Plouj/)
...
Using [libdlna](http://libdlna.geexbox.org/) might be a good idea.

Having a cross platform solution is almost a must.

*Proposed mentor: funman*

*Interested students: Hang Su Mirsal Ennaime[User:herbert]*

### GUI interfaces for the browsers plug-ins

This project focuses on adding interfaces to our browser plug-ins, in order to have, in the web pages embedded mode, buttons to control [VLC media player](https://wiki.videolan.org/VLC_media_player/) as in WMP or Youtube player. These buttons need to be cross-platform and cross-browsers.
...
This project is easy to describe, it would provide a fullscreen controller for Linux/Unix and Windows, as [VLC media player](https://wiki.videolan.org/VLC_media_player/) already has on Mac OS X version since 0.8.6.
...
Aim: [VLC on Mac fullscreen controller](http://download.videolan.org/vlc/screenshots/0.8.6/VLC-mac-Fullscreen.jpg)

*Proposed mentor: jb* (backup atmo)
...
Current versions of [VLC media player](https://wiki.videolan.org/VLC_media_player/) have a lot of problems on Windows Vista (check the forums for specifics).
...
See [Windows Vista Video Pipeline Architecture And Implementation](http://download.microsoft.com/download/5/b/9/5b97017b-e28a-4bae-ba48-174cf47d23cd/MED134_WH06.ppt) and [DirectShow Improvements in Vista](http://msdn2.microsoft.com/en-us/library/ms788119.aspx)
...
See with [jb](https://wiki.videolan.org/User:J-b/)
...
We have a more general page for ideas for Project in [VLC media player](https://wiki.videolan.org/VLC_media_player/), that could give you ideas: [Mini_Projects](https://wiki.videolan.org/Mini_Projects/).
...
- use this
[Talk page](https://wiki.videolan.org/Talk:SoC_2008/), - use the
[vlc-devel](http://www.videolan.org/developers/lists.html)mailing list, - come on IRC
[irc://irc.videolan.org](irc://irc.videolan.org)#videolan - contact one of the mentors or the backup mentors,
- or contact
[Jean-Baptiste Kempf](https://wiki.videolan.org/User:J-b/)
