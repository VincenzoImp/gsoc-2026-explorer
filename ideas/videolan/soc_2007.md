...
**Source:** https://wiki.videolan.org/SoC_2007/
**Scraped:** 2026-02-22T23:28:47.574422
...
*VideoLAN is a mentoring organization — List of accepted projects can be found here*
...
We are now a mentoring organisation ([mentors on SoC Website](http://code.google.com/support/bin/answer.py?answer=60303&topic=10727)).
...
We (the VideoLAN team, and [jb](https://wiki.videolan.org/User:J-b/), the author of this page) have split this page in two lists of ideas:

- The
*main ideas*are the ones we would like to focus on, and seem to be key projects for VLC and a lot more*thrilling*than the other ones; we have assigned a potential mentor to each of these. - The other ideas are less detailled but could be good ideas too.
...
This project is easy to describe, it would provide a fullscreen controller for Linux/Unix and Windows, as [VLC media player](https://wiki.videolan.org/VLC_media_player/) already has on MacOS X version since 0.8.6.
...
- Creation a
[VLC media player](https://wiki.videolan.org/VLC_media_player/)framework that can be used by both VLC.app and VLCplugin.bundle to integrate better with other Mac applications - Adapt and use Leopard enhancements in
[VLC media player](https://wiki.videolan.org/VLC_media_player/): QTKit Capture API, Resolution independence, iChat Theatre, ...
...
KDE4 will be out with a new framework for multimedia, this year. Using [VLC media player](https://wiki.videolan.org/VLC_media_player/) as a back-end for phonon would be great!
...
- use this
[Talk page](https://wiki.videolan.org/Talk:SoC_2007/), - use the
