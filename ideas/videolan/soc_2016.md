...
**Source:** https://wiki.videolan.org/SoC_2016/
**Scraped:** 2026-02-22T23:28:47.575110
...
This wiki page covers the work of the [VLMC](https://wiki.videolan.org/VLMC/) project as a mentoring organization for [Google Summer of Code](https://summerofcode.withgoogle.com), in order to improve our VideoLAN Movie Creator ([VLMC](https://wiki.videolan.org/VLMC/)).

## Contents

### VideoLAN Movie Creator

[VLMC](https://wiki.videolan.org/VLMC/) is a cross-platform non-linear video editing software based on VLC technology. It was started as a final year student project at the French IT school [EPITECH](http://www.epitech.eu).
...
We have 3 major communication channels: Our [mailing-lists](https://mailman.videolan.org/mailman/listinfo) to discuss patches and further development related topics. Furthermore, we have our [web forums](http://forum.videolan.org) for VLC-related end-user support - a VLMC section will be created once the product is published. Finally, there is our IRC channel *#vlmc* on the *Freenode* network. It's open to any kind of discussion. Usage issues, questions how to compile VLMC, getting to know the fellow developers, etc.
...
Meanwhile, a new binding got written ([https://code.videolan.org/videolan/libvlcpp/tree/master](https://code.videolan.org/videolan/libvlcpp/tree/master)), and needs to be plugged in.
