...
**Source:** https://wiki.videolan.org/SoC_2021/
**Scraped:** 2026-02-22T23:28:47.575559
...
This page gives the current list of ideas for VideoLAN project, for the [Google Summer Of Code 2021](https://summerofcode.withgoogle.com) program.
...
[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 How to Start](https://wiki.videolan.org#How_to_Start)[3 Ideas for VLC & libVLC](https://wiki.videolan.org#Ideas_for_VLC_.26_libVLC)[3.1 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[3.2 VLC Qt interface redesign](https://wiki.videolan.org#VLC_Qt_interface_redesign)[3.3 VLC.js](https://wiki.videolan.org#VLC.js)[3.4 VLC macOS interface redesign](https://wiki.videolan.org#VLC_macOS_interface_redesign)[3.5 Scripting VLC with wasm](https://wiki.videolan.org#Scripting_VLC_with_wasm)[3.6 VLC iOS UI update](https://wiki.videolan.org#VLC_iOS_UI_update)[3.7 Interactive movie support](https://wiki.videolan.org#Interactive_movie_support)[3.8 Develop a MPD server inside VLC](https://wiki.videolan.org#Develop_a_MPD_server_inside_VLC)[3.9 Improve the web interface of VLC in Vue.js](https://wiki.videolan.org#Improve_the_web_interface_of_VLC_in_Vue.js)[3.10 Improve VLCKit Objective-C - Swift interoperability](https://wiki.videolan.org#Improve_VLCKit_Objective-C_-_Swift_interoperability)[3.11 Other ideas for VLC & libVLC](https://wiki.videolan.org#Other_ideas_for_VLC_.26_libVLC)
...
Your goal is to develop GPU shaders for motion-adaptive frame interpolation in the style of [mvtools](https://wiki.videolan.org/SoC_2021/[https:/github.com/dubhater/vapoursynth-mvtools](https:/github.com/dubhater/vapoursynth-mvtools)).
