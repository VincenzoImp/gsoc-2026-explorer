...
**Source:** https://wiki.videolan.org/SoC_2009/
**Scraped:** 2026-02-22T23:28:47.574612
...
The projects that are being done in GSoC 2009 can be found [here](https://wiki.videolan.org/SoC_2009_projects/).
...
[x264](https://wiki.videolan.org/X264/):.[SoC x264 2009](https://wiki.videolan.org/SoC_x264_2009/)

If you are a **student**, please read [the rules and advice](https://wiki.videolan.org/SoC_2009_Rules/).
...
See [http://jpeg.dinauz.org/VideoLAN/gsoc/](http://jpeg.dinauz.org/VideoLAN/gsoc/)
...
This project focuses on adding interfaces to our browser plug-ins, in order to have, in the web pages embedded mode, buttons to control [VLC media player](https://wiki.videolan.org/VLC_media_player/) as in WMP or Youtube player. These buttons need to be cross-platform and cross-browsers. A right-click context menu with basic commands might be a nice way to get started.
...
- use this
[Talk page](https://wiki.videolan.org/Talk:SoC_2009/), - use the
