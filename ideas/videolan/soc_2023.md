...
**Source:** https://wiki.videolan.org/SoC_2023/
**Scraped:** 2026-02-22T23:28:47.575743
...
This page gives the current list of ideas for VideoLAN project, for the [Google Summer Of Code 2023](https://summerofcode.withgoogle.com) program.
...
[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 How to Start](https://wiki.videolan.org#How_to_Start)[3 Ideas for VLC & libVLC](https://wiki.videolan.org#Ideas_for_VLC_.26_libVLC)[3.1 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[3.2 Unreal Engine libVLC module](https://wiki.videolan.org#Unreal_Engine_libVLC_module)[3.3 VLC Qt interface redesign](https://wiki.videolan.org#VLC_Qt_interface_redesign)[3.4 Improve chromecast support (subtitles)](https://wiki.videolan.org#Improve_chromecast_support_.28subtitles.29)[3.5 VLC.js](https://wiki.videolan.org#VLC.js)[3.6 VLC macOS interface redesign](https://wiki.videolan.org#VLC_macOS_interface_redesign)[3.7 Improve Android MediaCodec support](https://wiki.videolan.org#Improve_Android_MediaCodec_support)[3.8 Rewrite some C modules in Rust](https://wiki.videolan.org#Rewrite_some_C_modules_in_Rust)[3.9 Add multiple audio tracks playback support](https://wiki.videolan.org#Add_multiple_audio_tracks_playback_support)[3.10 Scripting VLC with wasm](https://wiki.videolan.org#Scripting_VLC_with_wasm)[3.11 VLC iOS UI update](https://wiki.videolan.org#VLC_iOS_UI_update)[3.12 Interactive movie support](https://wiki.videolan.org#Interactive_movie_support)[3.13 Develop a MPD server inside VLC](https://wiki.videolan.org#Develop_a_MPD_server_inside_VLC)[3.14 Improve the web interface of VLC in Vue.js](https://wiki.videolan.org#Improve_the_web_interface_of_VLC_in_Vue.js)[3.15 Improve libNDI and integrate in VLC](https://wiki.videolan.org#Improve_libNDI_and_integrate_in_VLC)[3.16 Implement DVD-Audio deciphering](https://wiki.videolan.org#Implement_DVD-Audio_deciphering)[3.17 Other short ideas for VLC & libVLC](https://wiki.videolan.org#Other_short_ideas_for_VLC_.26_libVLC)
...
Your work will be based on Loic work: [https://code.videolan.org/videolan/vlc/-/merge_requests/2738](https://code.videolan.org/videolan/vlc/-/merge_requests/2738) (Not yet merged)
...
Your goal is to develop GPU shaders for motion-adaptive frame interpolation in the style of [mvtools](https://wiki.videolan.org/SoC_2023/[https:/github.com/dubhater/vapoursynth-mvtools](https:/github.com/dubhater/vapoursynth-mvtools)).
