...
**Source:** https://wiki.videolan.org/SoC_2010/
**Scraped:** 2026-02-22T23:28:47.574696
...
This wiki page covers the attempt by the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project to act as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC media player](https://wiki.videolan.org/VLC_media_player/), [x264](https://wiki.videolan.org/X264/), the H.264 video encoder, and VLMC. The accepted projects are seen on a [separate page](https://wiki.videolan.org/SoC_2010_projects/).



## Contents

[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 Key VLC projects](https://wiki.videolan.org#Key_VLC_projects)[2.1 Shader support for DirectX/OpenGL](https://wiki.videolan.org#Shader_support_for_DirectX.2FOpenGL)[2.2 Rewrite Matroska demuxer](https://wiki.videolan.org#Rewrite_Matroska_demuxer)[2.3 Audio Filters](https://wiki.videolan.org#Audio_Filters)[2.4 VLC Test Suite](https://wiki.videolan.org#VLC_Test_Suite)[2.5 VLC Personnal Cloud Project 2.0](https://wiki.videolan.org#VLC_Personnal_Cloud_Project_2.0)[2.6 Enhanced DVD Audio support](https://wiki.videolan.org#Enhanced_DVD_Audio_support)[2.7 Interface for VLC on Mobile phones](https://wiki.videolan.org#Interface_for_VLC_on_Mobile_phones)[2.8 Blu-ray enhancements](https://wiki.videolan.org#Blu-ray_enhancements)[2.9 RTMPdump](https://wiki.videolan.org#RTMPdump)[2.10 UPNP DLNA Server and Client](https://wiki.videolan.org#UPNP_DLNA_Server_and_Client)[2.11 Assembly optimizations in VLC](https://wiki.videolan.org#Assembly_optimizations_in_VLC)[2.12 Set of lua extensions](https://wiki.videolan.org#Set_of_lua_extensions)

[3 Phonon ideas](https://wiki.videolan.org#Phonon_ideas)[4 VLMC (VideoLAN Movie Creator) ideas](https://wiki.videolan.org#VLMC_.28VideoLAN_Movie_Creator.29_ideas)[5 Supplementary ideas](https://wiki.videolan.org#Supplementary_ideas)[6 Questions? Contact us?](https://wiki.videolan.org#Questions.3F_Contact_us.3F)
...
[VideoLAN](https://wiki.videolan.org/VideoLAN/) was a mentoring organization in [2007](https://wiki.videolan.org/SoC_2007/), [2008](https://wiki.videolan.org/SoC_2008/) and [2009](https://wiki.videolan.org/SoC_2009/).

- This page list the ideas for VLC.
- There is also a separate page for project ideas for
[x264](https://wiki.videolan.org/X264/):.[SoC x264 2010](https://wiki.videolan.org/SoC_x264_2010/)

If you are a **student**, please read [the rules and advice](https://wiki.videolan.org/SoC_2010_Rules/).

### VLC media player

[VLC media player](https://wiki.videolan.org/VLC_media_player/) is a cross-platform multimedia player, encoder and streamer application.
...
- The
*main ideas*are what seem to be*key projects*for VLC and should be more*thrilling*than the other ones; we have assigned a potential mentor to each of these. - Phonon ideas, for KDE/Phonon work.
- The other ideas are less detailed but could be good ideas too.
- VLMC ideas
[Mini_Projects](https://wiki.videolan.org/Mini_Projects/)are short-span projects which can be given as Qualification tasks or extended to be Full Summer of Code project.
...
For x264 ideas, please see [SoC x264 2010](https://wiki.videolan.org/SoC_x264_2010/).
...
This sections welcomes all **Original** ideas which can be implemented in a short span of time.However, We have a more general page for ideas for Project in [VLC media player](https://wiki.videolan.org/VLC_media_player/), that could give you ideas: [Mini_Projects](https://wiki.videolan.org/Mini_Projects/).
