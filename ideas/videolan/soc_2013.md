...
**Source:** https://wiki.videolan.org/SoC_2013/
**Scraped:** 2026-02-22T23:28:47.574986
...
This wiki page covers the work of the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC media player](https://wiki.videolan.org/VLC_media_player/).

## Contents

[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 Key ideas for VLC](https://wiki.videolan.org#Key_ideas_for_VLC)[2.1 3D video playback](https://wiki.videolan.org#3D_video_playback)[2.2 CC EIA-708 Closed Caption support](https://wiki.videolan.org#CC_EIA-708_Closed_Caption_support)[2.3 Timed Text TTML support](https://wiki.videolan.org#Timed_Text_TTML_support)[2.4 Digital Cinema DCP playback](https://wiki.videolan.org#Digital_Cinema_DCP_playback)[2.5 Chrome OS' NaCl support for VLC's core](https://wiki.videolan.org#Chrome_OS.27_NaCl_support_for_VLC.27s_core)[2.6 UPNP DLNA Server and Client](https://wiki.videolan.org#UPNP_DLNA_Server_and_Client)[2.7 Assembly optimizations in VLC](https://wiki.videolan.org#Assembly_optimizations_in_VLC)[2.8 VLC Android Port improvements](https://wiki.videolan.org#VLC_Android_Port_improvements)[2.9 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[2.10 VLC Test Suite](https://wiki.videolan.org#VLC_Test_Suite)[2.11 VLC Personal Cloud Project 2.0](https://wiki.videolan.org#VLC_Personal_Cloud_Project_2.0)[2.12 Playlist improvements](https://wiki.videolan.org#Playlist_improvements)[2.13 AirPlay streaming](https://wiki.videolan.org#AirPlay_streaming)[2.14 MSI Windows Installer](https://wiki.videolan.org#MSI_Windows_Installer)[2.15 VLC Sync Play across devices](https://wiki.videolan.org#VLC_Sync_Play_across_devices)[2.16 Native Emotion integration](https://wiki.videolan.org#Native_Emotion_integration)[2.17 XML fast and small implementation](https://wiki.videolan.org#XML_fast_and_small_implementation)

[3 Other Ideas for VLC](https://wiki.videolan.org#Other_Ideas_for_VLC)

## Introduction & Information

This wiki page covers the attempt by the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project to act as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC media player](https://wiki.videolan.org/VLC_media_player/).

[VideoLAN](https://wiki.videolan.org/VideoLAN/) was a mentoring organization in [2007](https://wiki.videolan.org/SoC_2007/), [2008](https://wiki.videolan.org/SoC_2008/), [2009](https://wiki.videolan.org/SoC_2009/), [2010](https://wiki.videolan.org/SoC_2010/) and [2011](https://wiki.videolan.org/SoC_2011/).
...
[VLC media player](https://wiki.videolan.org/VLC_media_player/) is downloaded at an approximate monthly rate of 40 millions from the main website and that's not including third-party distributions (Linux)!
...
Following up with the recent developments in the US, we need full support for [CEA-708](http://en.wikipedia.org/wiki/CEA-708).

We will extend our [support for EIA-608 in VLC 2.1](http://www.youtube.com/watch?v=1WhMEWIb2S4), so a base is laid, which needs to be expanded and improved.
...
Based on the W3C specification, we need support for [Timed Text Markup Language](http://www.w3.org/TR/ttaf1-dfxp/) to display widely formatted text in time with video or / and audio. If time allows, this project should be expanded to add support for SMPTE-TT's additional elements.
...
Improve the current VLC for [Android](http://git.videolan.org/?p=vlc/vlc-ports/android.git;a=summary).
...
The goal of this project is to improve and stabilize the upcoming default installer for the Windows platform. You'll have to work with the [Wix](http://wixtoolset.org) toolkit and the autotools building system.
...
Proposed mentor: hpi and [j-b](https://wiki.videolan.org/User:J-b/).
