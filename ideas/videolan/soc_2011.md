...
**Source:** https://wiki.videolan.org/SoC_2011/
**Scraped:** 2026-02-22T23:28:47.574824
...
This wiki page covers the work of the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC media player](https://wiki.videolan.org/VLC_media_player/), [x264](https://wiki.videolan.org/X264/), the H.264 video encoder, and VLMC.


[Accepted projects](https://wiki.videolan.org/Category:SoC_2011_Project/) can be found on a [separate page](https://wiki.videolan.org/Category:SoC_2011_Project/).



## Contents

[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 Ideas](https://wiki.videolan.org#Ideas)[3 Key ideas for VLC](https://wiki.videolan.org#Key_ideas_for_VLC)[3.1 New Audio Filters](https://wiki.videolan.org#New_Audio_Filters)[3.2 Porting Audio Filters](https://wiki.videolan.org#Porting_Audio_Filters)[3.3 UPNP DLNA Server and Client](https://wiki.videolan.org#UPNP_DLNA_Server_and_Client)[3.4 Assembly optimizations in VLC](https://wiki.videolan.org#Assembly_optimizations_in_VLC)[3.5 VLC Android Port](https://wiki.videolan.org#VLC_Android_Port)[3.6 VLC Test Suite](https://wiki.videolan.org#VLC_Test_Suite)[3.7 VLC Personnal Cloud Project 2.0](https://wiki.videolan.org#VLC_Personnal_Cloud_Project_2.0)[3.8 VLC for Anime](https://wiki.videolan.org#VLC_for_Anime)[3.9 SVCD/VCD improvements](https://wiki.videolan.org#SVCD.2FVCD_improvements)[3.10 Automatic LibVLC bindings generation](https://wiki.videolan.org#Automatic_LibVLC_bindings_generation)[3.11 OMA/Atrac improvements](https://wiki.videolan.org#OMA.2FAtrac_improvements)[3.12 Playlist improvements](https://wiki.videolan.org#Playlist_improvements)[3.13 AirTune streaming](https://wiki.videolan.org#AirTune_streaming)[3.14 BD-J / BD-Live](https://wiki.videolan.org#BD-J_.2F_BD-Live)[3.15 Http interface improvements](https://wiki.videolan.org#Http_interface_improvements)

[4 Other Ideas for VLC](https://wiki.videolan.org#Other_Ideas_for_VLC)[5 VLC Student Proposals](https://wiki.videolan.org#VLC_Student_Proposals)[6 VLMC](https://wiki.videolan.org#VLMC)

## Introduction & Information

This wiki page covers the attempt by the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project to act as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC media player](https://wiki.videolan.org/VLC_media_player/) and [X264](https://wiki.videolan.org/X264/), the H.264 video encoder.

[VideoLAN](https://wiki.videolan.org/VideoLAN/) was a mentoring organization in [2007](https://wiki.videolan.org/SoC_2007/), [2008](https://wiki.videolan.org/SoC_2008/), [2009](https://wiki.videolan.org/SoC_2009/) and [2010](https://wiki.videolan.org/SoC_2010/).

- This page list the ideas for VLC and VLMC
- There is also a separate page for project ideas for
[X264](https://wiki.videolan.org/X264/):.[SoC x264 2011](https://wiki.videolan.org/SoC_x264_2011/)

If you are a **student**, please read [the rules and advice](https://wiki.videolan.org/SoC_2011_Rules/).
...
[VLC media player](https://wiki.videolan.org/VLC_media_player/) is downloaded at an approximate monthly rate of 5 millions from the main website and that's not including third-party distributions (Linux)!
...
- The
*main ideas*are what seem to be*key projects*for VLC and should be more*thrilling*than the other ones; we have assigned a potential mentor to each of these. - The other ideas are less detailed but could be good ideas too.
- VLMC ideas
[Mini Projects](https://wiki.videolan.org/Mini_Projects/)are short-span projects which can be given as Qualification tasks or extended to be Full Summer of Code project.
...
If you don't want to apply for SoC but want other ideas to develop on, check the [Mini Projects](https://wiki.videolan.org/Mini_Projects/) page!

And on the IRC channel, you can have even more ideas.

### Ideas for x264

For x264 ideas, please see [SoC x264 2011](https://wiki.videolan.org/SoC_x264_2011/).
...
Improve current VLC [android port](http://git.videolan.org/?p=vlc/vlc-android.git;a=summary), improve/add native/java interfaces and design and implement a GUI.
...
A good example of the aim is [http://www.vodobox.c.la/](http://www.vodobox.c.la/)
...
We advice to use Swig (from [http://www.swig.org/](http://www.swig.org/)) but any other tool is accepted too.
...
[Http interface improvements](https://wiki.videolan.org/SoC_2011/Web_Interface_Improvements/)
...
[http://www.youtube.com/watch?v=ou5prh-EoBs](http://www.youtube.com/watch?v=ou5prh-EoBs)
...
1. [Download and build](http://wiki.videolan.org/Building_VLMC) VLMC and start playing with it.

2. Implement some feature(s) or fix some bug(s), search VLMC's [bug tracker](http://trac.videolan.org/vlmc/report).
...
1. [Bug 134](http://trac.videolan.org/vlmc/ticket/134): Update labels and strings when locale is changed.

2. [Bug 61](http://trac.videolan.org/vlmc/ticket/61): Improve project timeline widget to have clip thumbnail.

3. [Bug 145](http://trac.videolan.org/vlmc/ticket/145): Project preview has no sound on Windows.

4. [Bug 196](http://trac.videolan.org/vlmc/ticket/196): Fix distorted audio playback in project preview.

5. [Bug 144](http://trac.videolan.org/vlmc/ticket/144): On some platforms, rendered video file has no sound. Identify the problem and fix it.
