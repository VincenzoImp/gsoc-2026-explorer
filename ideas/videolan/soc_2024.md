...
**Source:** https://wiki.videolan.org/SoC_2024/
**Scraped:** 2026-02-22T23:28:47.575936
...
This page gives the current list of ideas for VideoLAN project, for the [Google Summer Of Code 2024](https://summerofcode.withgoogle.com) program.
...
[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 How to Start](https://wiki.videolan.org#How_to_Start)[3 Ideas for VLC & libVLC](https://wiki.videolan.org#Ideas_for_VLC_.26_libVLC)[3.1 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[3.2 VLC Qt interface redesign](https://wiki.videolan.org#VLC_Qt_interface_redesign)[3.3 VLC Skins2 interface update](https://wiki.videolan.org#VLC_Skins2_interface_update)[3.4 VLC macOS interface redesign](https://wiki.videolan.org#VLC_macOS_interface_redesign)[3.5 Improve Android MediaCodec support](https://wiki.videolan.org#Improve_Android_MediaCodec_support)[3.6 Add back netsync module](https://wiki.videolan.org#Add_back_netsync_module)[3.7 Add AAC via S/PDIF and Bluetooth support](https://wiki.videolan.org#Add_AAC_via_S.2FPDIF_and_Bluetooth_support)[3.8 Scripting VLC with wasm](https://wiki.videolan.org#Scripting_VLC_with_wasm)[3.9 Port the VLC iOS UI to visionOS](https://wiki.videolan.org#Port_the_VLC_iOS_UI_to_visionOS)[3.10 VLC iOS UI update](https://wiki.videolan.org#VLC_iOS_UI_update)[3.11 Qt integration tests](https://wiki.videolan.org#Qt_integration_tests)[3.12 Cloud integration for desktop](https://wiki.videolan.org#Cloud_integration_for_desktop)[3.13 Interactive movie support](https://wiki.videolan.org#Interactive_movie_support)[3.14 Implement Pipewire input module for audio and video](https://wiki.videolan.org#Implement_Pipewire_input_module_for_audio_and_video)[3.15 Improve the web interface of VLC in Vue.js](https://wiki.videolan.org#Improve_the_web_interface_of_VLC_in_Vue.js)[3.16 Improve libNDI and integrate in VLC](https://wiki.videolan.org#Improve_libNDI_and_integrate_in_VLC)[3.17 Update the Lua integration](https://wiki.videolan.org#Update_the_Lua_integration)[3.18 Implement DVD-Audio deciphering](https://wiki.videolan.org#Implement_DVD-Audio_deciphering)[3.19 Radio-Browser integation](https://wiki.videolan.org#Radio-Browser_integation)[3.20 Port the remote access webserver to VLC Desktop](https://wiki.videolan.org#Port_the_remote_access_webserver_to_VLC_Desktop)[3.21 Other short ideas for VLC & libVLC](https://wiki.videolan.org#Other_short_ideas_for_VLC_.26_libVLC)
...
**Project Description**:
Render AAC encoded content via S/PDIF and Bluetooth
...
**Project Description**:
VLCKit supports visionOS. Now it is time for the UI to follow. We want a port of the existing iOS UI without support for any cloud services. This mostly implies layout fixes to work-around limitations of the SDK. When everything works, it is time to start adopting platform specific elements.
...
**Requirements**:
This project requires **Obj-C** and **Swift** knowledge.
...
**Requirements**:
Very good **C** knowledge, Audio and Video knowledge
...
Your goal is to develop GPU shaders for motion-adaptive frame interpolation in the style of [mvtools](https://wiki.videolan.org/SoC_2024/[https:/github.com/dubhater/vapoursynth-mvtools](https:/github.com/dubhater/vapoursynth-mvtools)).
