...
**Source:** https://wiki.videolan.org/SoC_2019/
**Scraped:** 2026-02-22T23:28:47.575369
...
This page summarize the current list of ideas for VideoLAN project, for [Google Summer Of Code 2019](https://summerofcode.withgoogle.com).

The list is not exhaustive, and is not limitative. Feel free to apply with **your own idea!**

## Contents

[1 Introduction & Information](https://wiki.videolan.org#Introduction_.26_Information)[2 How to Start](https://wiki.videolan.org#How_to_Start)[3 Ideas for VLC & libVLC](https://wiki.videolan.org#Ideas_for_VLC_.26_libVLC)[3.1 Advanced Audio Filters](https://wiki.videolan.org#Advanced_Audio_Filters)[3.2 VLC Qt interface redesign](https://wiki.videolan.org#VLC_Qt_interface_redesign)[3.3 VLC macOS interface redesign](https://wiki.videolan.org#VLC_macOS_interface_redesign)[3.4 GPU shader filters](https://wiki.videolan.org#GPU_shader_filters)[3.5 Integrate JS engine in VLC](https://wiki.videolan.org#Integrate_JS_engine_in_VLC)[3.6 VLC on Android Testsuite](https://wiki.videolan.org#VLC_on_Android_Testsuite)[3.7 VLCKit Testsuite](https://wiki.videolan.org#VLCKit_Testsuite)[3.8 VLC iOS new UI](https://wiki.videolan.org#VLC_iOS_new_UI)[3.9 Open Source Fuzzing platform](https://wiki.videolan.org#Open_Source_Fuzzing_platform)[3.10 Interactive movie support](https://wiki.videolan.org#Interactive_movie_support)[3.11 Develop a MPD server inside VLC](https://wiki.videolan.org#Develop_a_MPD_server_inside_VLC)[3.12 Improve the web interface of VLC in Vue.js](https://wiki.videolan.org#Improve_the_web_interface_of_VLC_in_Vue.js)[3.13 Improve VLCKit Objective-C - Swift interoperability](https://wiki.videolan.org#Improve_VLCKit_Objective-C_-_Swift_interoperability)[3.14 Other ideas for VLC & libVLC](https://wiki.videolan.org#Other_ideas_for_VLC_.26_libVLC)

[4 Ideas for VLMC](https://wiki.videolan.org#Ideas_for_VLMC)[5 Ideas for VLC dependencies](https://wiki.videolan.org#Ideas_for_VLC_dependencies)

## Introduction & Information

This wiki page covers the attempt by the [VideoLAN](https://wiki.videolan.org/VideoLAN/) project to act as a mentoring organization for [Google Summer of Code](http://code.google.com/soc/), in order to improve [VLC](https://wiki.videolan.org/VLC/), [VLMC](https://wiki.videolan.org/VLMC/) and **dav1d** (or the [libVLC](https://wiki.videolan.org/LibVLC/) engine).
...
**Project Description**:
VLC is scriptable today with the Lua programming language. While slim and efficient, it is a less known programming language than other, like JS.
...
**Requirements**:
This project requires **C** knowledge and **JS** knowledge.
...
**Project Description**:
VLC on Android is the port of VLC on the Android platform. It is one of the most used version of VLC.
...
**Requirements**:
This project requires **Java** and **Kotlin** knowledge and some development on Android.
...
The framework is furthermore used by thousands of Apps all over the world on iOS, tvOS and macOs and subject to everyday change.
...
The [rav1e](https://github.com/xiph/rav1e) project aims to create a new AV1 encoder implementation in
Rust.
