...
- Play with Mixxx and explore what it can do. Read the
[Mixxx manual](https://mixxx.org/manual/latest/)to get a better understanding of Mixxx's capabilities and what people use it for. - Introduce yourself early on our
[Zulip chat](https://mixxx.zulipchat.com/).**If you have not introduced yourself until a few days before the application deadline, we will not accept your application.**Start a new topic in the #gsoc stream. Do not hesitate to ask questions, or ask for a helping hand to get started. Please make sure you have read**this**page carefully before.**If the first question you ask is clearly answered on this page, you will likely not be accepted, because it strongly suggests that you lack the ability to work independently.** - Participate in Zulip discussions that are not directly related to your GSOC project.
-
[Test and review pull requests](https://github.com/testing). Post comments on GitHub pull requests suggesting ways to improve the code more. - Look through the
[start#Developer Documentation](https://github.com/home#Developer%20Documentation)and make a small code contribution to fix a bug or enhance an existing feature. - Help users with technical questions about Mixxx on the
[forum](https://mixxx.org/forums/). - Report bugs on our
[issue tracker](https://github.com/mixxxdj/mixxx/issues).
...
Involved](https://github.com#Getting%20Involved) in the community. This will help you
...
Mixxx is created by and for humans, not by and for AI.

GSoC is about

- learning to interact with a community,
- leaning to develop, in a given codebase,
- learning to adapt to rules and regulations of a community,
- extending your coding and analysing skills.

It's an experience, by using AI you would miss all this.

AI chat & code tools can be used as

- helpers to get more information about functions,
- to find links to videos or c++ syllabus,
- a dictionary,

but you can't let it do the work for you.

Please be honnest about how you use AI within the community and with mentors, write a note as

- 'I used AI to find ... ' or
- 'I used AI to translate / rewrite ... '.

We use various AI detection tools to check proposals, comments, explanations, and of course: code. If our AI detectors turn red, which means there's a high probability that the text/code was generated by AI, your application or project will be immediately rejected, regardless of its stage.

- In case you're a candidate you'll be disqualified.
- In case you may have started a GSoC project as a contributor: the project ends and you fail your GSoC evaluation.
...
Please be honnest to yourself: if your only experience is a 'hello world' routine, if you have problems setting up the Mixxx-development/building environment or if the Mixxx-code makes you dizzy, you probalbly won't be qualified to participate to a high standard codebase like Mixxx.

See it as a challenge: learn more c++/qt/cmake while hanging around in the community, create your first (basic) PRs, learn from other contributors and apply next year with a lot of extra knowledge.
...
you like. We primarily use
[Zulip](https://mixxx.zulipchat.com/)and comments on[GitHub pull requests](https://github.com/mixxxdj/mixxx/pulls)to communicate. - If there are good reasons for not communicating please announce them early. If you know there will be times that you are not able to work on your project as much during the summer, please let us know in your application.
...
-
[Set up an IDE](https://github.com/Developer%20Tools#Using%20IDEs)to start exploring the area of the code you will be working on and understanding how the classes work together. Read the[Developer Guide](https://github.com/Developer%20Guide)for an introduction to the organization of the Mixxx code. Feel free to ask us on[Zulip](https://mixxx.zulipchat.com/)if you need help figuring out where to start looking in the code. - Figure out what parts of the code need to be changed and come up with a general idea of what those changes will be.
- Write a draft application
*early*so we can help you with feedback before the final application deadline. We recommend submitting a draft application at least one week before the final application deadline. If you wait until the last few days to submit your first draft, it will be hard for you to respond to feedback in time. - Don't be afraid to give us lots of detail about how you would approach the project
- UI mockups are very much encouraged where appropriate
- Consider how much time you need for each part of the project
- Include links to C++ code you have written before
- If you have prior experience DJing, mention it in your application
...
*must*have submitted a pull request to Mixxx or provide links to code they have written before in their application (ideally both). - Has the student demonstrated that they can work independently and solve problems on their own without asking for help every step of the way?
...
- Besides the qualification criteria that result in a quotation, we also have some others. If we got the impression that a candidate won't make it to qualification (approval of proposal) we'll say so. Honesty is important.
- There are also some party stoppers:
- setting up your building environment (with pre-commit), create a PR that gets merged in which an easy issue is fixed.
- binding with the community: interact with other members in different subjects, show a real interest in Mixxx.
- we'd love to communicate with you in an easy way. In an ongoing chat we love fast response. We prefer reading typing errors and baby English over a polished online translator answer.

- We plan video interviews with a selection of candidates in which we will ask you about C++, qt and your proposal.
