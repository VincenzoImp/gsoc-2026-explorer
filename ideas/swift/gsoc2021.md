...
**Scraped:** 2026-02-22T23:28:47.610332
...
If you would like to reach out to a mentor privately, rather than making a public forums post, and the forums are not allowing you to send private messages (yet), please reach out to Konrad Malawski at `ktoso @ apple.com`

directly via email with the `[gsoc2021]`
...
](https://www.swift.org#tracking-for-typecheckers-type-inference)
...
[GSoC 2020 page](https://www.swift.org/gsoc2020/#tracking-for-typecheckers-type-inference), minus the interactive command line tool part due to shorter coding period)
...
](https://www.swift.org#referencing-enclosing-self-in-a-property-wrapper-type)
...
- Future directions section of the Property Wrappers Swift Evolution proposal:
[Referencing the enclosing ‘self’ in a wrapper type](https://github.com/swiftlang/swift-evolution/blob/main/proposals/0258-property-wrappers.md#referencing-the-enclosing-self-in-a-wrapper-type)
...
](https://www.swift.org#transparent-logs-system-for-protecting-the-swift-package-ecosystem)
...
### Scripting in Swift [
](https://www.swift.org#scripting-in-swift)
...
- The
[SwiftPM support for Swift scripts](https://forums.swift.org/t/swiftpm-support-for-swift-scripts/33126)thread has an initial design that could be used as the basis of this work. It may need some polish, figuring out the details the project cound aim for implementing a basic version of it.
...
](https://www.swift.org#increase-differentiable-programmings-language-coverage)
...
](https://www.swift.org#swift-numerics-decimal64)
...
](https://www.swift.org#swift-data-structure-implementation-priority-queue-weak-setdictionary-or-other-useful-data-structure)
...
](https://www.swift.org#tooling-for-swiftmodule-files)
...
](https://www.swift.org#show-swift-inferred-types-in-vscode-using-sourcekit-lsp)
...
### Alive2 for SIL [
](https://www.swift.org#alive2-for-sil)
...
### More ideas [
](https://www.swift.org#more-ideas)
...
Projects must have a tangible result, and be possible to successfully complete by a student within the allocated ~175 hours for the project. New project ideas will need to find a mentor to endorse the project in order to be accepted.
