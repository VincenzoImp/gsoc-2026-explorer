...
**Source:** https://wiki.osgeo.org/wiki/Google_Summer_of_Code_2021_Ideas
**Scraped:** 2026-03-10T16:58:40.291781
...
[Google Summer of Code 2021](https://wiki.osgeo.org/wiki/Google_Summer_of_Code_2021)wiki page.
...
## OSGeo Google Summer of Code 2021
...
**Students: check out the**([Google Summer of Code Recommendations for Students](https://wiki.osgeo.org/wiki/Google_Summer_of_Code_Recommendations_for_Students)page. If you need more information on how to apply you can contact all the mentors via the OSGeo-SoC mailing list[see below](https://wiki.osgeo.org#How_to_get_in_contact_via_mailing_lists)) And look at[GSoC Roles and Responsibilities](https://developers.google.com/open-source/gsoc/help/responsibilities)to understand a successful teamwork and interplay of project, mentors, and students.
...
[Google Summer of Code 2021 Administrative](https://wiki.osgeo.org/wiki/Google_Summer_of_Code_2021_Administrative)wiki page.
...
:**MapMint**Ideas[MapMint](http://mapmint.com/)is an internet-based Geographic Information System (GIS), which is designed to facilitate deployment of Spatial Data Infrastructure (SDI). MapMint combines various different software in a complete and coherent web mapping platform, thus helping users in building their own maps and web-applications."
...
[Back to [Google Summer of Code 2021](https://wiki.osgeo.org/wiki/Google_Summer_of_Code_2021) @ OSGeo]
