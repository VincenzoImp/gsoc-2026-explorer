...
**Parent:** Python Software Foundation — Project Ideas
**Source:** https://python-gsoc.org/index.html
**Scraped:** 2026-03-10T16:58:40.278150
...
GSoC 2026 has been announced!

## Python is hoping to apply to GSoC 2026, but right now we don't know anything! We will not have a list of sub-orgs until late January 2026 and there is no guarantee we will be accepted as a mentoring org.

Contributors: Please start with the [Python GSoC getting started guide](https://python-gsoc.org/#gettingstarted).
Our list of 2026 participating sub orgs can be found [on the ideas page](https://python-gsoc.org/ideas.html). Please talk to the organizations directly.
Now's a good time to get familiar with the projects and their needs.

Mentors and sub-orgs:
Please [contact the org admins](https://python-gsoc.org#contact) if you want to be part of GSoC 2026.
