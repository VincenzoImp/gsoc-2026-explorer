...
See also: [2025](https://community.kde.org/GSoC/2025), [2024](https://community.kde.org/GSoC/2024), [2023](https://community.kde.org/GSoC/2023), [2022](https://community.kde.org/GSoC/2022), [2021](https://community.kde.org/GSoC/2021), [2020](https://community.kde.org/GSoC/2020), [2019](https://community.kde.org/GSoC/2019), [2018](https://community.kde.org/GSoC/2018), [2017](https://community.kde.org/GSoC/2017), [2016](https://community.kde.org/GSoC/2016), [2015](https://community.kde.org/GSoC/2015), [2014](https://community.kde.org/GSoC/2014), [2013](https://community.kde.org/GSoC/2013), [2012](https://community.kde.org/GSoC/2012), [2011](https://community.kde.org/GSoC/2011), [2010](https://community.kde.org/GSoC/2010), [previous GSoCs](http://techbase.kde.org/Projects/Summer_of_Code)
...
All participants will need a Google account in order to join the program. So, save time and create one now. In addition, all KDE students need to join the [KDE student list, KDE-Soc](https://mail.kde.org/mailman/listinfo/kde-soc). In addition, if you do not yet have a [KDE account](https://identity.kde.org); set that up now.
...
First of all, please read the [instructions common to all participants](https://community.kde.org#All_participants) and the [GSoC FAQ](https://developers.google.com/open-source/gsoc/faq). Pay special attention to the **Eligibility** section of the FAQ.

### Recommended steps

- Join the
[KDE programs list](https://mail.kde.org/mailman/listinfo/kde-soc)and[KDE Mentorship Matrix channel](https://community.kde.org/Matrix)introduce yourself, and meet your fellow developers - Read
[Google's Getting Started Page](https://summerofcode.withgoogle.com/get-started)and the[GSoC Student Manual](https://google.github.io/gsocguides/student/) - Take a look at the
[list of ideas](https://community.kde.org/GSoC/2026/Ideas) - Come up with project that you're interested in
- Write a first draft
[proposal](https://community.kde.org#Student_proposal_guidelines)and get someone to review it - Remember: you must link to work such as commits in your proposal
- Remember to explain your interest in KDE as an organization as well as the project
- Submit your proposal using
[Google's web interface](https://summerofcode.withgoogle.com/)ahead of the deadline - Submit proof of
[eligibility](https://developers.google.com/open-source/gsoc/faq#what_are_the_eligibility_requirements_for_participation)well ahead of the deadline
...
Read this note about AI usage provided by Google (these are suggestions based on feedback from the 2025 Mentor Surveys): [https://docs.google.com/document/d/1t9GcIBnNXPNO6klRQvU8pL8-uV6afzLo6JUAM299suA/edit?usp=sharing](https://docs.google.com/document/d/1t9GcIBnNXPNO6klRQvU8pL8-uV6afzLo6JUAM299suA/edit?usp=sharing)
...
All contributors will create a report page linked from here: [Status Reports](https://community.kde.org/GSoC/2022/StatusReports). Keep this up-to-date, as this is one of our primary evaluation tools. Ensure that your blogs are on the [KDE Planet](https://planetkde.org/) and linked on the status page.

## Instructions for mentors

### Ideas

If you're a KDE developer and you wish to participate in Summer of Code, make a proposal in the [ideas page](https://community.kde.org/GSoC/2024/Ideas), based what your KDE project needs.

If you wish to mentor, please read the [instructions common to all participants](https://community.kde.org#All_participants) and the [Summer of Code FAQ](https://developers.google.com/open-source/gsoc/faq#general). Also, please contact the maintainer for your application or module and get the go-ahead from hir before editing the ideas page, adding your idea.
...
- Log in to
[GSoC webapp](https://summerofcode.withgoogle.com)after being added as a mentor by one of the admins - Subscribe to
[KDE-soc-mentor mail list](https://mail.kde.org/mailman/listinfo/kde-soc-mentor)
...
To reach the KDE administrators for Summer of Code, please write [[email protected]](https://community.kde.org/cdn-cgi/l/email-protection).
