...
**Source:** https://www.nsnam.org/wiki/GSOCSelectionProcess
**Scraped:** 2026-03-10T16:58:40.233820
...
- The candidate does not have any other commitments over the summer, and can devote the time required of GSOC candidates.
- The proposal has been discussed at length on the mailing list and/or Zulip.
...
With respect to confidentiality and professional responsibilities of the review process, the selection committee is expected to treat the process similar to a peer reviewed, technical program committee. Example guidelines are [posted here](http://s2013.siggraph.org/submitters/ethics-art-papers-review-process).
