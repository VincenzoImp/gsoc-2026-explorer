...
**Source:** https://www.nsnam.org/wiki/GSOCMentorGuide
**Scraped:** 2026-03-10T16:58:40.233699
...
- At least one mentor on the mentoring team
**must**be a maintainer of some sort (commit privileges on the code server, or equivalent). This policy will allow us to also shepherd new mentors into the ns-3 project. - Mentors will be selected based on the contributor projects selected.
...
Mentors are not paid. Google pays the ns-3 project a $500 stipend per contributor, and the project deposits the funding to the [the ns-3 SPI](https://www.spi-inc.org/projects/ns-3/) gift account (funding to support the open source project). If you would like an exception and to take payment as an individual, please contact the org admins about it.
...
[1] [https://summerofcode.withgoogle.com/rules/](https://summerofcode.withgoogle.com/rules/)

[2] [http://write.flossmanuals.net/gsoc-mentoring/about-this-manual/](http://write.flossmanuals.net/gsoc-mentoring/about-this-manual/)
