# 2026 GSoC Contributor application template

**Parent:** The ns-3 Network Simulator Project — Project Ideas
**Source:** https://www.nsnam.org/wiki/GSOC2025ApplicationTemplate
**Scraped:** 2026-02-22T23:28:47.554647

---

# GSOC2025ApplicationTemplate
...
[ns-3's GSoC Contributor guide][ns-3's GSoC Mentor guide]Get in contact with the ns-3 team:[Google group]|Zulip[https://ns-3.zulipchat.com]
...
Name. Your nameCountry. Your country of citizenshipInstitution. Accredited institution where you are enrolled as student (college, university, master program, PhD program, undergraduate program, etc), if applicable.Advisor. (if applicable). Is your research work supervised by a professor or research group?## Patch Requirement

Provide a URL to a repository (or pointer to publicly available commits, or a GitLab snippet, or email one of the org admins, with a patch that satisfies your patch requirement for your application to ns-3. Completion of either the

[suggested patch assignment]or a comparable code submission is *mandatory*. Some project ideas have project-specific patch requirements (check with the mentor about it).

Note:If you opt to provide a patch to the problem described in the patch requirement, keep your solution private by pasting the link to your code in your application to Google, not posting it on the mailing list or submitting a GitLab.com merge request.## Background
...
Highlight if you are applying for a small sized project (90 hours), medium sized project (175 hours) or a large project (350 hours).
...
How will you convince a skeptic that the implementation works correctly?## Approach
