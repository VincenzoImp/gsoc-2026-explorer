...
We use a non-commercial license of [Prince XML](http://www.princexml.com/) to generate the PDF version of the documentation. For more information see our [meta documentation page](https://precice.org/docs-meta-publish-to-pdf.html).
...
You can find the preCICE [privacy policy here](https://precice.org/privacy.html).
