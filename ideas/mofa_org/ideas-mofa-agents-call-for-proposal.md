...
**Source:** https://github.com/mofa-org/GSoC/blob/main/ideas/mofa-agents/call-for-proposal.md
**Scraped:** 2026-03-10T16:58:40.266751
...
3. **Pluggable backend abstraction.** MoFA's `InferenceBackend` trait (see [Idea 3](https://github.com/mofa-org/GSoC/blob/main/ideas-list.md)) is designed to be backend-agnostic. OminiX-MLX is the default macOS backend, but the same agent code should work with a CUDA backend on Linux or a future NPU backend on other hardware — without modification.
...
4. **Read [Idea 3: Edge Model Orchestrator](https://github.com/mofa-org/GSoC/blob/main/ideas-list.md)** — it covers the scheduling and memory management aspects of multi-model orchestration.
...
6. **Write a proposal** with a feasible, phased action plan. See the [proposal template](https://github.com/mofa-org/GSoC/blob/main/proposal-template.md).
