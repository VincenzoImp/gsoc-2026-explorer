...
**Source:** https://github.com/mofa-org/GSoC/blob/main/zh/ideas-list.md
**Scraped:** 2026-03-10T16:58:40.267367
...
> **开始之前**：请先在相关 GitHub issue 下留言表达兴趣，并简要描述你的思路。**等待维护者分配后再开始编码。** 这可以避免重复劳动。详见[贡献流程](https://github.com/mofa-org/GSoC/blob/main/zh/README.md#在-gsoc-之前贡献)。
>
...
- 框架与基础设施方向：[MoFA, an AI Native Framework for Agent](https://github.com/mofa-org/GSoC/blob/main/ideas/framework-for-ai/call-for-proposal.md)
- 模型编排方向：[MoFA Agents: Support All Models](https://github.com/mofa-org/GSoC/blob/main/ideas/mofa-agents/call-for-proposal.md)
- 人机交互方向：[MoFA's HCI for AI Native Agent Framework](https://github.com/mofa-org/GSoC/blob/main/ideas/studio-for-ai/call-for-proposal.md)
- 批判性分析方向：[Why MoFA](https://github.com/mofa-org/GSoC/blob/main/ideas/why-mofa/call-for-proposal.md)

---

## 开放任务 — 从这里开始贡献

以下是 MoFA 代码库中具体的、可独立完成的任务。它们是在 GSoC 之前或期间熟悉项目的好方式。**在相关 issue 下留言即可认领** —— 见[认领规则](https://github.com/mofa-org/GSoC/blob/main/zh/README.md#我们如何选人)。
...
__GSoC 贡献者指南:__ [README.md](https://github.com/mofa-org/GSoC/blob/main/zh/README.md)
