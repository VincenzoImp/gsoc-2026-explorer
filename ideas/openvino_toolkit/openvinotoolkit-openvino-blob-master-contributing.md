...
See also: [AI Usage Policy](https://github.com/openvinotoolkit/openvino/blob/master/AI_USAGE_POLICY.md).
...
### Contribute Code Changes
   ...
   * **Fix Bugs or Develop New Features**
     ...
     [create a Pull Request](https://github.com/openvinotoolkit/openvino/blob/master/CONTRIBUTING_PR.md) addressing it. If you want to start with something simple,
...
### Improve documentation
   ...
   * The easiest way to help with documentation is to review it and provide feedback on the
     ...
     You can also create a Pull Request directly, following the [editor's guide](https://github.com/openvinotoolkit/openvino/blob/master/CONTRIBUTING_DOCS.md).
