...
We set up [this activity plan](https://docs.google.com/spreadsheets/d/1vt3DmEUBiDiy0hHPURbf-lS4_JRv6N-SSl-p_vRKmQk/edit#gid=0) to track our admin tasks. This plan tells you who is responsible for the tasks below (and more) - and when they're slated for action.
...
[GSoC (Google Summer of Code)](https://drive.google.com/drive/folders/0Bx19372m_9u6ODhOOHk4bXRZMDQ)Google Drive folderWiki
...
[openmrs.org](http://openmrs.org)email address (if you don’t already have an assigned @[openmrs.org](http://openmrs.org)email address associated with your OpenMRS ID, contact the help desk to get one).
...
See [here](https://talk.openmrs.org/t/gsoc-2018-project-mentor-brainstorming/15248) (2018) and [here](https://talk.openmrs.org/t/gsoc-2017-project-brainstorming/9783) (2017) for example/template Talk posts to introduce GSoC, and identify potential projects & mentors.
...
[https://openmrs.org](https://openmrs.org)Our tagline is “Write code. Save lives.”

You can use the

[OMRS-cross.jpg](https://drive.google.com/file/d/1yu2UlXcHn4ryP1MqEDnX66JWmUe7_LlD/view?usp=sharing)file for our logo. If you find a better version of the logo to use, be sure to include a copy of the logo file in the Google Drive (for next year’s reference) and update this document accordingly.Category is: Science and Medicine
...
Post to Talk when student application period opens, e.g. see

[here](https://talk.openmrs.org/t/gsoc-2018-student-applications-now-open/16777/1)and[here](https://talk.openmrs.org/t/gsoc-2017-students-applications-period-openned/10641).What students should be doing
...
Once all blogs have been shared, these should be added to the feeds on [http://planet.openmrs.org](http://planet.openmrs.org). To do this, the blog URLs should be added to the [openmrs-contrib-planet](https://github.com/openmrs/openmrs-contrib-planet) repository, where they will be auto-deployed to OSUOSL (hosting OpenMRS Planet). You should fork this repository, create a new branch, add the list of blog feeds to openmrs-planet.ini, and open a PR against the base repository to have this merged, e.g.:
...
[https://docs.google.com/forms/d/e/1FAIpQLSe70Wxp40WhZvFzjWcko8DZhT5nRiuQGC_CCF6QSFn261wywQ/viewform](https://docs.google.com/forms/d/e/1FAIpQLSe70Wxp40WhZvFzjWcko8DZhT5nRiuQGC_CCF6QSFn261wywQ/viewform)[https://docs.google.com/forms/d/11yFCXAM6vkVEEhTlIij9C681PbWMTZARvYFy5GG7ogQ/edit](https://docs.google.com/forms/d/11yFCXAM6vkVEEhTlIij9C681PbWMTZARvYFy5GG7ogQ/edit)
...
[https://google.github.io/gsocguides/mentor/evaluations](https://google.github.io/gsocguides/mentor/evaluations)

[https://google.github.io/gsocguides/student/evaluations](https://google.github.io/gsocguides/student/evaluations)
...
[https://developers.google.com/open-source/gsoc/help/evaluations](https://developers.google.com/open-source/gsoc/help/evaluations)
...
[here](https://openmrs.org/2017/09/thank-you-all-for-making-gsoc-2017-a-success/)for an example of the GSoC 2017 post summarizing the GSoC experience for that year.

Updating this document and other GSoC resources

Update GSoC wiki page

Move project wiki pages to

[Completed Projects](https://openmrs.atlassian.net/wiki/display/projects/Completed+Projects)and remove the links from the[Unassigned Projects](https://openmrs.atlassian.net/wiki/display/projects/Unassigned+Projects)page.
...
No, the GSoC Admin can reach out to admins from previous years (see Contacts) for guidance. Also GSoC Admin(s) are encouraged to join [OpenMRS Project Management (PM) calls](https://openmrs.atlassian.net/wiki/display/RES/Project+Management+Meeting) to give updates on how they things are going and whether there are any blockages or issues they need help with.

# Resources

Timelines and general information - [https://summerofcode.withgoogle.com/](https://summerofcode.withgoogle.com/)
