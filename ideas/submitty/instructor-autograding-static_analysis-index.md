# Autograding using Static Analysis

**Parent:** Submitty — Project Ideas
**Source:** https://submitty.org/instructor/autograding/static_analysis/index
**Scraped:** 2026-02-22T23:28:47.549672

---

Submitty provides a number of utilities for analysis of student code
through the [assignment autograding configuration](https://submitty.org/instructor/autograding/) interface.
...
*Note: submitty_count is an alias for a program installed on the
...
The next level of analysis enables counting *nodes* within a parse tree, which
...
See also the [Visualization Tool for Abstract Syntax Trees](https://submitty.org/tree_tool).
