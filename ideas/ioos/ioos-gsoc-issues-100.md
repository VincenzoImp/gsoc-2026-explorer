...
**Source:** https://github.com/ioos/gsoc/issues/100
**Scraped:** 2026-03-10T16:58:40.285296
...
The National Ocean Service (NOS) is currently developing a Python package to assess the skill of their [Operational Forecast Systems (OFS)](https://tidesandcurrents.noaa.gov/models.html). The goal of this project is to work with the NOS team and improve the skill assessment package by:
...
Link to coding-related challenge applicants should complete: [https://github.com/NOAA-CO-OPS/Next-Gen-NOS-OFS-Skill-Assessment/issues/5](https://github.com/NOAA-CO-OPS/Next-Gen-NOS-OFS-Skill-Assessment/issues/5)

### Additional Project Background/Links

[Link to project code repo](https://github.com/NOAA-CO-OPS/Next-Gen-NOS-OFS-Skill-Assessment )
