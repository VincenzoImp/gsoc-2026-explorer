...
**Source:** https://github.com/libreswan/libreswan/wiki/https:/datatracker.ietf.org/doc/draft-ietf-ipsecme-ikev2-downgrade-prevention
**Scraped:** 2026-02-22T23:28:47.597533

---

-
[Notifications](https://github.com/login?return_to=%2Flibreswan%2Flibreswan)You must be signed in to change notification settings -
[Fork 242](https://github.com/login?return_to=%2Flibreswan%2Flibreswan)

# Home

[15 revisions](https://github.com/libreswan/libreswan/wiki/Home/_history)

The Libreswan Project [https://libreswan.org/](https://libreswan.org/)
...
install target installs in `/usr/local`
...
[https://lists.libreswan.org/](https://lists.libreswan.org/)

Wiki:

Libreswan's wiki is at [https://libreswan.org/wiki/Main_Page](https://libreswan.org/wiki/Main_Page). It
...
Bugs can be reported on the mailing list [swan-dev@lists.libreswan.org](mailto:swan-dev@lists.libreswan.org)
...
proper CVE tracking numbers (see [https://www.mitre.org/](https://www.mitre.org/)) and will be
...
Please contact [security@libreswan.org](mailto:security@libreswan.org) or:
...
[swan-dev@lists.libreswan.org](mailto:swan-dev@lists.libreswan.org) or talk to the development team on IRC in
#libreswan on irc.libera.chat

For those who want to track things a bit more closely, the
[swan-commits@lists.libreswan.org](mailto:swan-commits@lists.libreswan.org) mailing list will mail all the commit
...
[Completed Projects](https://github.com/Completed-Projects)
